  ...
  return (
    <div className="relative overflow-hidden bg-white flex-grow flex items-center min-h-screen">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-y-0 right-0 w-1/2 bg-neutral-200 -skew-x-12 transform origin-top-right"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/fake-id"
                className="inline-flex items-center justify-center px-6 py-3 bg-black hover:bg-neutral-900 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5"
              >
            ...
            <div className="flex items-center text-sm text-neutral-700 font-medium bg-neutral-100 px-4 py-2 rounded-lg border border-neutral-200">
          ...
          <div className="lg:col-span-4 hidden lg:flex items-center">
            <div className="relative h-full w-full">
              <div className="absolute inset-0 bg-neutral-200/50 rounded-2xl transform rotate-3"></div>
              <div className="absolute inset-0 bg-white rounded-2xl shadow-xl border border-neutral-200">
                <div className="p-6 h-full flex flex-col justify-center">
                  <div className="w-full h-32 bg-neutral-900 rounded-lg mb-4"></div>
                  <div className="w-3/4 h-4 bg-neutral-300 rounded mb-3"></div>
                  <div className="w-1/2 h-4 bg-neutral-300 rounded mb-6"></div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-neutral-100/50 to-transparent"></div>
    </div>
  )
}
